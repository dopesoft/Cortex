...
const availableApps: AvailableApp[] = [
  ...
  { id: 'claude code', name: 'Claude Code', description: 'MCP integration for Claude Code CLI', priority: 9.5, category: 'Development', trustScore: 98 },
  ...
  // { id: 'enconvo', name: 'Enconvo', description: 'Environment configuration tool', priority: 0, category: 'Development', trustScore: 86 },
  {
    ...
    installCommand: '-y mcp-remote https://cortex-memory-api-virginia.onrender.com/mcp/v2/chorus/{USER_ID}',
    category: 'Assistant',
    isComingSoon: false,
    priority: -1,
  },
